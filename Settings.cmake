...
# Add pybind11
#ADD_SUBDIRECTORY(/usr/share/cmake/pybind11 ${PROJECT_SOURCE_DIR}/tmp_bin)
...
OPTION(DEFINE_WITH_CGAL "Enable CGAL" ON) # Enabled by default
OPTION(DEFINE_WITH_CGAL_COREFINEMENT "Enable CGAL Corefinement" ON) # Enabled by default

IF(DEFINE_WITH_CGAL)
    ADD_DEFINITIONS(-DWITH_CGAL)
ENDIF(DEFINE_WITH_GCAL)

IF(DEFINE_WITH_CGAL_COREFINEMENT)
    ADD_DEFINITIONS(-DWITH_CGAL_COREFINEMENT)
ENDIF(DEFINE_WITH_GCAL_COREFINEMENT)
